...
namespace NetSentinel.Models {
    public enum TrafficProtocol { HTTP, DNS, TCP, UDP, ICMP, Other }
    public class TrafficRecord {
        public int Id { get; set; }
        [MaxLength(50)] public string SourceIp { get; set; } = string.Empty;
        [MaxLength(50)] public string DestinationIp { get; set; } = string.Empty;
